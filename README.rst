...
` <https://travis-ci.org/josuebrunel/myql>`_ `|Documentation
Status| <https://myql.readthedocs.org>`_ `|Latest
...
`|image4| <https://pypi.python.org/pypi/myql>`_ `|Join the chat at
...
.. |image4| image:: https://pypip.in/implementation/myql/badge.svg
.. |Join the chat at
